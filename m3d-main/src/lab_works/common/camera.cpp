...
namespace M3D_ISICG
{
	...
	Vec3f Camera::getPos() { return _position; }
	...
	{
		_projectionMatrix = glm::perspective( glm::radians( _fovy ), // Convertit FOVY en radians.
											  _aspectRatio, // Ratio d'aspect de la fen tre (largeur / hauteur).
											  _zNear,		// Plan proche.
											  _zFar			// Plan lointain.
		);
	}
